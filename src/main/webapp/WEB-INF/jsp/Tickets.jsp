            ...
            <center>
                ...
                <table id="seatsBlock">
                    ...
                    <tr>
                        ...
                        <td rowspan="20">
                            <div class="smallBox greenBox" style="color:red;">Selected Seat</div> <br />
                            <div class="smallBox redBox" style="color:red;">Reserved Seat</div><br />
                            <div class="smallBox emptyBox" style="color:red;">Empty Seat</div><br />
                        </td>
                ...
                <br /><button onclick="updateTextArea()" style="color:">Confirm Selection</button>
            </center>
        </div>
